...
Route::group(['middleware' => ['auth', 'permission']], function() {
    ...
    Route::group(['prefix' => 'manage-media'], function(){
        Route::get('add', [MediaController::class, 'showMediaForm'])->name('manage-media.add');
        Route::post('store', [MediaController::class, 'store'])->name('manage-media.store');
        Route::get('edit/{id}', [MediaController::class, 'edit']);
        Route::post('update', [MediaController::class, 'update'])->name('manage-media.update');
...
Route::get('work', [FrontHomeController::class, 'workPage'])->name('work');
Route::get('work/{slug}', [FrontHomeController::class, 'workDetailsPage']);
...
Route::get('blog/{slug}', [FrontHomeController::class, 'blogDetailsPage']);
