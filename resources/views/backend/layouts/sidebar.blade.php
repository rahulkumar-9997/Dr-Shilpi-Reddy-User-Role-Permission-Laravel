   ...
   <div class="page-sidebar-wrapper" id="main-menu-wrapper">
      ...
      <ul class='wraplist'>
         ...
         <li class="{{ request()->is('manage-feature-logo') ? 'open' : ''}}"> 
            ...
            <span class="title">Manage Featured Logo</span>
            </a>
         </li>
         <li class="{{ request()->is('manage-testimonials') ? 'open' : ''}} {{ request()->is('manage-testimonials/add') ? 'open' : ''}}">
            <a href="javascript:;">
         ...
         <li class="{{ request()->is('manage-blog') ? 'open' : ''}} {{ request()->is('manage-our-work/add') ? 'open' : ''}}">
            <a href="javascript:;">
            ...
            <ul class="sub-menu" >
               ...
               <li>
                  <a class="" href="{{route('manage-media.add')}}">Add new blog</a>
               </li>
