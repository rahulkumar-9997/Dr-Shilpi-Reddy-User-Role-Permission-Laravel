                ...
                <div class="service-box-inner-con our_core_value">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 pl-0 pr-0 border-right-0 core_value_grid">
                        <div class="service-box-item core_value_service_box text-center">
                            <figure>
                                <img src="{{asset('fronted/shilpi-img/women_empowerment.webp')}}" alt="Women Empowerment" class="img-fluid core-value-img">
                            </figure>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 pl-0 pr-0 border-right-0 core_value_grid">
                        <div class="service-box-item core_value_service_box text-center">
                            <figure>
                                <img src="{{asset('fronted/shilpi-img/Mental-Health-Awareness.webp')}}" alt="Mental Health Awareness" class="img-fluid core-value-img">
                            </figure>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 pl-0 pr-0 core_value_grid">
                        <div class="service-box-item core_value_service_box text-center">
                            <figure>
                                <img src="{{asset('fronted/shilpi-img/Physical-&-Emotional-Well-Being.webp')}}" alt="Physical & Emotional Well Being" class="img-fluid core-value-img">
                            </figure>
                    ...
                    <div class="col-lg-5 col-md-5 d-md-flex align-items-center">
                        <div class="quality-system-right-con position-relative text-center overlay-img">
                            <figure class="mb-4 about-dad-img">
                                <img src="{{asset('fronted/shilpi-img/TELANGANA_STATEWIDE_CAMPAIGN_1.webp')}}" alt="professional-doctor-img" class="img-fluid">
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-5 d-md-flex align-items-center">
                        <div class="quality-system-right-con position-relative text-center overlay-img">
                            <figure class="mb-4 about-dad-img">
                                <img src="{{asset('fronted/shilpi-img/TELANGANA_STATEWIDE_CAMPAIGN_2.webp')}}" alt="professional-doctor-img" class="img-fluid">
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-7 d-flex align-items-center">
                ...
                <div class="row">
                    ...
                    <div class="quality-system-left-con text-center">
                        <p>
                            ...
                            <BR>
                            For enquires and support kindly contact he below.
                        </p>
                        <a href="contact.php" class="appointment-btn foundation_btn">Contact Us</a>
                    </div>
                    </div>
                </div>
            </div>
