...
<link rel="stylesheet" href="{{asset('fronted/css/mobile.css')}}">
<link rel="stylesheet" href="{{asset('fronted/css/dr_shilpi_css.css')}}">
...
<!-- work -->
<link rel="stylesheet" href="{{asset('fronted/css/super-classes.css')}}">
<link rel="stylesheet" href="{{asset('fronted/css/custom-style.css')}}">
    <!-- work -->
